...
local setGrid = function(x, y)
  local fstr = string.format('%dx%d', x, y)
...
local setAppHotKey = function(mods, key, appBundleId)
  hs.hotkey.bind(mods, key, function() focusApp(appBundleId) end)
end
...
--
setAppHotKey({ 'alt' }, 'D', 'com.kapeli.dashdoc')
setAppHotKey({ 'alt' }, 'E', 'com.github.wez.wezterm')
setAppHotKey({ 'alt' }, 'F', 'com.google.Chrome')
setAppHotKey({ 'alt' }, 'I', 'com.jetbrains.intellij')
setAppHotKey({ 'alt' }, 'O', 'com.tinyspeck.slackmacgap')
setAppHotKey({ 'alt' }, 'U', 'com.microsoft.VSCode')
setAppHotKey({ 'alt' }, 'B', 'notion.id')
