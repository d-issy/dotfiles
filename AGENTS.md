...
- Do not read, write, or access files under `~/` directly; always work through this repository
- Do not commit; create a branch with `git switch -c` and let the user handle commits
