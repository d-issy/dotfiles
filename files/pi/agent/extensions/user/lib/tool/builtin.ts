		...
		defineToolContribution({
			...
			definition: {
				...
				promptGuidelines: [
					...
					"If replaces.oldText matches multiple locations, specify startLineNo/endLineNo or targetLineNoRanges for a safe range that contains only intended replacements.",
					"Only use a wider oldText when the same line contains multiple matches, because line ranges cannot disambiguate within one line.",
				],
